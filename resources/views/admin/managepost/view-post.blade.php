...
<table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer dtr-inline" style="width: 100%;" role="grid" aria-describedby="datatable-buttons_info">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$posts->status_name}}</td>
            <td>
                <a href="{{url('admin/change-status').'/'.$posts->post_id}}/1" >Active</a>
            </td>
            <td>
                <a href="{{url('admin/change-status').'/'.$posts->post_id}}/0" >Inactive</a>
            </td>
            <td>
                <a href="{{url('admin/change-status').'/'.$posts->post_id}}/2" >Pending</a>
            </td>
        </tr>
        <tr>
            <td>Details</td>

...
@section('content_title')
    <h2>Add New Upazila</h2>
@endsection
@section('content')

<form action="{{url('admin/upazila/')}}" method="post" enctype="multipart/form-data" id="demo-form2"
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
            <input name="upazila_name" type="text" value="{{old('upazila_name')}}" class="form-control ">
            @error('upazila_name')
                <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
